...
const lambdaLightStack = new LambdaLightStack(app, naming.lambdaLightStackName(), commonProps);

// Deploy Lambda Heavy functions (can be parallel with Light)
const lambdaHeavyStack = new LambdaHeavyStack(app, naming.lambdaHeavyStackName(), commonProps);

// Deploy Step Functions last (depends on all Lambda functions)
const stepFunctionsStack = new StepFunctionsStack(app, naming.stepFunctionsStackName(), commonProps);
