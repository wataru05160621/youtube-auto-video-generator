        ...
        SecretsAccess: new iam.PolicyDocument({
          statements: [
            new iam.PolicyStatement({
              ...
              resources: [
                `arn:aws:secretsmanager:${this.region}:${this.account}:secret:${this.naming.secretName('openai')}*`,
                `arn:aws:secretsmanager:${this.region}:${this.account}:secret:${this.naming.secretName('google')}*`,
              ],
            }),
          ],
        }),
        ...
        SecretsAccess: new iam.PolicyDocument({
          statements: [
            new iam.PolicyStatement({
              ...
              resources: [
                `arn:aws:secretsmanager:${this.region}:${this.account}:secret:${this.naming.secretName('youtube')}*`,
                `arn:aws:secretsmanager:${this.region}:${this.account}:secret:${this.naming.secretName('google')}*`,
              ],
            }),
          ],
        ...
        LambdaInvoke: new iam.PolicyDocument({
          statements: [
            new iam.PolicyStatement({
              ...
              resources: [
                `arn:aws:lambda:${this.region}:${this.account}:function:${this.naming.lambdaFunctionName('*')}`,
              ],
            }),
          ],
        }),
