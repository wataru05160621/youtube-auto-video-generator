...
export class LambdaLightStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: LambdaLightStackProps) {
    ...
    this.readSpreadsheetFunction = new lambda.Function(
      this,
      "ReadSpreadsheetFunction",
      {
        ...
        code: lambda.Code.fromAsset(
          "../src/lambda-light/ReadSpreadsheetFunction"
        ),
    ...
    this.generateScriptFunction = new lambda.Function(
      this,
      "GenerateScriptFunction",
      {
        ...
        code: lambda.Code.fromAsset(
          "../src/lambda-light/GenerateScriptFunction"
        ),
        handler: "index.handler",
    ...
    this.writeScriptFunction = new lambda.Function(
      this,
      "WriteScriptFunction",
      {
        ...commonLambdaProps,
    ...
    this.generateImageFunction = new lambda.Function(
      this,
      "GenerateImageFunction",
      {
        ...
        code: lambda.Code.fromAsset(
          "../src/lambda-light/GenerateImageFunction"
        ),
        handler: "index.handler",
    ...
    this.synthesizeSpeechFunction = new lambda.Function(
      this,
      "SynthesizeSpeechFunction",
      {
        ...
        code: lambda.Code.fromAsset(
          "../src/lambda-light/SynthesizeSpeechFunction"
        ),
        handler: "index.handler",
